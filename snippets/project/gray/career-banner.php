                ...
                <div class="col-lg-6">
                    <div class="row py-5">
                        <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-sm-10 offset-sm-1 my-auto">
                            <h2 itemprop="headline"><?php echo APP_ABOUTUS_CAREER_TEAM_TITLE; ?></h2>
                            <p itemprop="description"><?php echo APP_ABOUTUS_CAREER_TEAM_DESCRIPTION; ?></p>
                        </div>
                    </div>
                </div>
                <meta itemprop="image" content="<?php echo APP_ABOUTUS_CAREER_TEAM_IMAGE; ?>">
                <div class="col-lg-6 career-banner bg-white">
                    <img itemprop="image" width="918" height="500" src="<?php echo APP_ABOUTUS_CAREER_TEAM_IMAGE; ?>"
                         alt="<?php echo APP_ABOUTUS_CAREER_TEAM_TITLE; ?>">
                </div>
            </div>
        </div>
    </div>

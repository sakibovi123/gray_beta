...
<section id="<?php echo lcfirst(SNIPPET_NAME_CORDELL);?>" class="<?php echo lcfirst(SNIPPET_NAME_CORDELL).' '.APP_NAME.SNIPPET_NAME_CORDELL.' '.SNIPPET_CATEGORY_CONTACTS.' '.SNIPPET_CSS_CLASSES;?> contact-details" itemscope itemtype="http://schema.org/Organization">
    ...
    <div class="row mb-4">
      ...
      <div class="col-lg-6 contact-form">
        <div class="contact-form-box">
          ...
          <form method="post" id="<?php echo APP_NAME; ?>Contactus" class="<?php echo APP_NAME; ?>Contactus" enctype="multipart/form-data" action="/thank-you.php">
     
              <div class="form-group">
                <input type="text" name="fullname" class="form-control" id="fullname" placeholder="<?php echo APP_CONTACTUS_NAME; ?>" required aria-label="<?php echo APP_CONTACTUS_NAME; ?>">
              </div>
              
            
            <div class="form-group">
              <input type="email" class="form-control" name="email" id="email" placeholder="<?php echo APP_CONTACTUS_EMAIL; ?>" required aria-label="<?php echo APP_CONTACTUS_EMAIL; ?>">
            </div>
            <div class="form-group">
              <input type="tel" class="form-control" name="phonenumber" id="phone" placeholder="<?php echo APP_CONTACTUS_PHONE; ?>"  required aria-label="<?php echo APP_CONTACTUS_PHONE; ?>">
            ...
            <div class="form-group">
              <select id="enqury-solution" class="form-control" required name="solution">
                ...
                <option value="<?php echo APP_CONTACTUS_SELECTIONG_TEXT; ?>"><?php echo APP_CONTACTUS_SELECTIONG_TEXT; ?></option>
              </select>
            </div>
            ...
            <div class="form-group">
              <textarea name="message" id="message" class="form-control" cols="30" rows="6" placeholder="<?php echo APP_CONTACTUS_MESSAGE; ?>" required aria-label="<?php echo APP_CONTACTUS_MESSAGE; ?>"></textarea>
            </div>
            <input type="hidden" name="token_gnerate" id="token_gnerate">
            <button type="submit" class="btn btn-brand"><?php echo APP_CONTACTUS_FORM_SUBMIT_TEXT; ?> <i class="fas fa-arrow-circle-right"></i></button>
          </form>
        </div>
      </div>
      <!-- contact info -->
        ...
        <div class="contact-type-box email">
          ...
          <div class="col">
            <div class="contact-type-box address">
              <h5><i class="fa fa-map-marker" aria-hidden="true"></i><span itemprop="name"><?php echo APP_CONTACTUS_BLOCKB_TITLE; ?></span></h5>
              <p class="lead pb-4" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
                          <span itemprop="streetAddress"><?php echo APP_ADDRESS_DHAKA;?></span>
                          <h5>
                <a href="tel:+8809638404040">
              <span itemprop="telephone"><i class="fas fa-phone"></i> </span>  <?php echo APP_PHONE_BD ?>
              </a>
              </h5>
              </p>
              <div class="contact-link">
                <a itemprop="url" href="<?php echo APP_CONTACTUS_BLOCKB_LINK; ?>" target="_blank"><?php echo APP_CONTACTUS_BLOCKB_LINK_TEXT; ?> <i class="<?php echo APP_CONTACTUS_BLOCKB_LINK_ICON; ?>"></i></a>
              </div>
            </div>
         ...
         <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.846856192943!2d90.37275925068849!3d23.75283994452408!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf44973223ed%3A0x8346aa32b9dea9be!2sGGLink!5e0!3m2!1sen!2suk!4v1645624073865!5m2!1sen!2suk" width="600" height="370" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
             </div>
        <!-- social links -->
        <div class="row social-links">
          <div class="col-lg-12 text-right">
            <a itemprop="sameAs" class="btn social-icon mx-1" href="<?php echo APP_FACEBOOK_LINK; ?>" title="<?php echo APP_FACEBOOK_TITLE; ?>" target="_blank"><i class="<?php echo APP_FACEBOOK_ICON; ?>"></i></a>
            <a itemprop="sameAs" class="btn social-icon mx-1" href="<?php echo APP_TWITTER_LINK; ?>" title="<?php echo APP_TWITTER_TITLE; ?>" target="_blank"><i class="<?php echo APP_TWITTER_ICON; ?>"></i></a>
            <a itemprop="sameAs" class="btn social-icon mx-1" href="<?php echo APP_LINKEDIN_LINK; ?>" title="<?php echo APP_LINKEDIN_TITLE; ?>" target="_blank"><i class="<?php echo APP_LINKEDIN_ICON; ?>"></i></a>
            <a itemprop="sameAs" class="btn social-icon mx-1" href="<?php echo APP_YOUTUBE_LINK; ?>" title="<?php echo APP_YOUTUBE_TITLE; ?>" target="_blank"><i class="<?php echo APP_YOUTUBE_ICON; ?>"></i></a>
          </div>
        </div>
      </div>
    </div>

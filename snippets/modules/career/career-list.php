            ...
            <div class="col-lg-10 mx-auto">
                <div class="job-list">                    
                    ...
                    <div itemprop="offers" itemscope itemtype="https://schema.org/Offer" class="job-box d-md-flex align-items-center justify-content-between mb-30">
                        ...
                        <div class="job-right my-4 flex-shrink-0">
                            <a itemprop="url" href="<?php echo APP_CAREER_LIST_JOB_LINK_3; ?>" class="btn d-block w-100 d-sm-inline-block btn-brand"><?php echo APP_CAREER_LIST_JOB_LINK_TEXT; ?></a>
                        </div>
                    </div>
                    <div itemprop="offers" itemscope itemtype="https://schema.org/Offer" class="job-box d-md-flex align-items-center justify-content-between mb-30">
                        <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                    ...
                    <div itemprop="offers" itemprop="offers" itemscope itemtype="https://schema.org/Offer" class="job-box d-md-flex align-items-center justify-content-between mb-30">
                        <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                            <div class="img-holder mr-md-4 mb-md-0 mb-4 mx-auto mx-md-0 d-md-none d-lg-flex">

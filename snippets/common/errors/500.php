            ...
            <div class="row">
                <div class="col-lg-12 ">
                    <div class="error-text">
                        <h1 itemprop="headline"><?php echo ERROR_500_TITLE; ?> </h1>
                        <div class="im-sheep">
                            <div class="top">
                                <div class="body"></div>
                                <div class="head">
                        ...
                        <h4 itemprop="name"><?php echo ERROR_500_SUBTITLE; ?></h4>
                        <p itemprop="description" class="lead"><?php echo ERROR_500_DESCRIPTION; ?></p>
                        <a itemprop="url" href="<?php echo ERROR_BUTTON_LINK; ?>" title="<?php echo ERROR_BUTTON_TEXT; ?>" class="btn btn-brand"><?php echo ERROR_BUTTON_TEXT; ?></a>
                    </div>
                </div>
            </div>
        </div>

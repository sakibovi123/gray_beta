            ...
            <div class="row">
                <div class="col-lg-12 ">
                    <div class="error-text">
                        <h1 itemprop="headline"><?php echo ERROR_401_TITLE; ?> </h1>
                        <div class="im-sheep">
                            <div class="top">
                                <div class="body"></div>
                                <div class="head">
                        ...
                        <h4 itemprop="name"><?php echo ERROR_401_SUBTITLE; ?></h4>
                        <p itemprop="description" class="lead"><?php echo ERROR_401_DESCRIPTION; ?></p>

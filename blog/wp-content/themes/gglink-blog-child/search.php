		...
		<div class="container blog-post-list mt-5 mt-4" id="blog-post-list">
			...
			<div class="row search-filter blog mb-4">
				...
				<div class="col-md-8 col-12 mt-4 mt-md-0 filter-type text-md-right text-sm-left">
					<?php if($wp_query->found_posts)post_sort_option_form(); ?>
				</div>
			</div>
			<div>
				<?php
				if($wp_query->found_posts)
				echo "<h4 class='mb-3'><i>Total ".$wp_query->found_posts." posts found.</i></h4>";
				?>
			...
			<div class="row blog-list" id="blog-list">
				...
				if ( have_posts() ) {
					...
					?>
					<div class="no-result-fond-style">
						<h3>No Result Found!</h3>
					    <div>
					        <a class="mt-2 btn btn-brand" href="<?php echo get_site_url(); ?>">Go to blog page</a>
					    </div>
					</div>
					<?php
				}
